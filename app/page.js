...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div>
        <h2>Join or Create a Video Call</h2>
      ...
      {/* <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
        ...
        >
          ...
          <input type="text" placeholder="dial id" className="rounded-sm mb-3" />
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            you can invite your friends after you start a call
          </p>
        </a>
        ...
        >
          ...
          <input type="text" placeholder="dial id" className="rounded-sm mb-3" />
          <Link className="border rounded px-3 py-1" href="/room">Join</Link>
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            enter the id to join a call
          </p>
        </a>
      </div> */}
    </main >
