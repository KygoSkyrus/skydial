...
const InviteDiaglog = ({ mySocketId }) => {
    ...
    return (
        <dialog id='invite_dialog' className='dark dark:bg-gray-900 dark:text-gray-100 lg:w-1/2 md:w-3/4 rounded-3xl' onClick={(e) => handleClick(e)}>
            <div className=' px-6 py-16 sm:px-12 md:px-16 xl:col-span-2'>
                <form method="dialog">
