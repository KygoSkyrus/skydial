...
const GetSVGIcon = ({ name, className }) => {
    ...
    switch (name) {
        ...
        case "user_plus":
            return (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 inline-block ms-2 ">
